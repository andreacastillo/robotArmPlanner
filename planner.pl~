...
move(pickup(X), [handempty, clear(X), ontable1(X)],
...
test :- go([handempty, ontable1( b), ontable2(c), on(a, b), clear(c), clear(a)],
	          [handempty, ontable(c), on(a,b), on(b, c), clear(a)]).

test2 :- go([handempty, ontable1(b), ontable2(c), on(a, b), clear(c), clear(a)],
	          [handempty, ontable1(a), ontable2(b), on(c, b), clear(a), clear(c)]).
